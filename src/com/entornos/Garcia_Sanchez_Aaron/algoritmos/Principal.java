...
public class Principal extends algoritmos {
	...
	public static void main(String[] args) {
		/* Apartado 1 - Crea mediante un bucle un array llamado “numeros” con 5
		números aleatorios del al 20.*/
		...
		/* Apartado 2 - Calcula mediante un bucle el número de fibonacci de los 5 
		números del array y almacena el resultado en otro array llamado 
		“resultadoFibonacci”.*/
		...
		/* Apartado 3 - Calcula mediante un bucle el factorial de los 5 números del
		...
		/* Apartado 4 - Comprueba mediante un bucle si los 5 números del 
		array son primos o no y almacena el resultado en otro array llamado “resultadoPrimos”.*/
